...
... artifacts are [released to Clojars](https://clojars.org/stdout-io). If you are using Maven, add the following repository
...
With Maven:
    ...
    <dependency>
      ...
      <artifactId>stdout-io</artifactId>
...
stdout-io is built from the ground up for Clojure 1.5.1 and up.


## Continuous Integration Status

[![Continuous Integration status](https://secure.travis-ci.org/clojurewerkz/stdout-io.png)](http://travis-ci.org/clojurewerkz/stdout-io)



## ... Is a ClojureWerkz Project

stdout-io is part of the [group of Clojure libraries known as ClojureWerkz](http://clojurewerkz.org), together with
